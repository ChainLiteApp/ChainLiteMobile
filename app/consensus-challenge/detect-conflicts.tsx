...
export default function DetectConflicts() {
  ...
  return (
    <LinearGradient colors={["#3a0a0a", "#7a1d1d"]} style={styles.container}>
      <BackHeader title="Detect Conflicts" onBack={() => router.back()} />
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.card}>
          <View style={styles.iconContainer}>
            <Ionicons name="alert-circle-outline" size={40} color="#fb923c" />
          </View>
          <Text style={styles.title}>Diverging Histories</Text>
          <Text style={styles.subtitle}>Why forks appear in distributed systems</Text>
          <View style={styles.divider} />
          <Text style={styles.paragraph}>
            When two miners find valid blocks nearly simultaneously, different parts of the network may see different tips. This creates temporary forks.
          </Text>
        </View>
      </ScrollView>
      <View style={styles.footer}>
        <View style={styles.buttonRow}>
          ...
          <TouchableOpacity style={styles.primaryButton} onPress={() => router.push('/consensus-challenge/competing-forks')}>
            <Text style={styles.primaryButtonText}>Next: Competing Forks</Text>
...
const styles = StyleSheet.create({
  ...
  iconContainer: { width: 70, height: 70, borderRadius: 20, backgroundColor: 'rgba(251, 146, 60, 0.25)', justifyContent: 'center', alignItems: 'center', marginBottom: 20, alignSelf: 'center' },
  ...
  secondaryButtonText: { color: '#fb923c', fontSize: 16, fontWeight: '600' },
});
